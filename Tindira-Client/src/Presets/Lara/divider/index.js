export default {
    root: ({ props }) => ({
        class: [
            ...
            // Color
            {
                'before:border-t before:border-surface-200 before:dark:border-surface-700': props.layout == 'horizontal',
                'before:border-l before:border-surface-200 before:dark:border-surface-700': props.layout == 'vertical'
            }
        ]
    }),
    content: {
